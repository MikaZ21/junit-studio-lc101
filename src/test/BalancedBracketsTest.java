...
public class BalancedBracketsTest {
    ...
    @Test
    public void onlyBracketsReturnsTure() {
        assertTrue(BalancedBrackets.hasBalancedBrackets("[]"));
    }
    @Test
    public void BracketsReturnsFalse() {
        assertFalse("][ should return false",BalancedBrackets.hasBalancedBrackets("]["));
    }
...
//        assertTrue(BalancedBrackets.hasBalancedBrackets("[LaunchCode]"));
        assertEquals("These strings have balanced brackets",BalancedBrackets.hasBalancedBrackets("[LaunchCode]"),true);
    }
